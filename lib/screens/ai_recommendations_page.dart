...
class _AIRecommendationsScreenState extends State<AIRecommendationsScreen> {
  String selectedHostel = 'Hostel H';
  ...
  Future<void> fetchAiRecommendations(Map<String, dynamic>? jsonData) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          aiResponse = decoded["candidates"][0]["content"]["parts"][0]["text"]
              .toString();
        });
      } else {
        setState(() {
  ...
  Future<void> fetchAiRecommendations2(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final decoded = jsonDecode(response.body);
        setState(() {
          aiResponse2 = decoded["candidates"][0]["content"]["parts"][0]["text"]
              .toString();
        });
      } else {
        setState(() {
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                ...
                Padding(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items: <String>['Hostel H', 'Hostel J', 'Soweto', 'Students\' center ']
            ...
            Padding(
              ...
              child: Card(
                color: Colors.grey[850], // Blends with the background
                child: Container(
